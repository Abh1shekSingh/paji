  ...
  },
  {
    ...
    return (
        <section ref={ref} className='min-h-screen p-10 w-[100%] bg-[var(--color-dark)] sm:rotate-5 sm:scale-[0.5] rounded-t-3xl'>
            <Copy>
              <h1 className='text-[3rem] w-full md:text-[6rem] 2xl:text-[7rem] leading-13 md:leading-30 2xl:leading-tight text-[var(--color-light)] uppercase heading font-bold w-3/4'>Web Presence, <span className='heading font-bold italic text-light opacity-70'>Perfected.</span></h1>
            </Copy>
            <Copy>
